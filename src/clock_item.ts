...
export class ClockItem {
    ...
    constructor(private timezone: string, alignment: vscode.StatusBarAlignment, priority: number) {
    ...
    private updateTime() {
        const now = new Date();
        const formattedDateTime = now.toLocaleString('en-US', { timeZone: this.timezone });
